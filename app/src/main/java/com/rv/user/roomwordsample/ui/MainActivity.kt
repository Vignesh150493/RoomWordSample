...
import com.rv.user.roomwordsample.presentation.WordViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mWordViewModel?.apply {
            allWords.observe(this@MainActivity, Observer { words -> adapter.setWords(words!!) })
        }
    }
